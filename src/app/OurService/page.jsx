    ...
    return (
        <div className='bg-white pb-5'>
            <div className='w-11/12 mx-auto'>
                <div className='grid grid-cols-1 lg:grid-cols-3 md:grid-cols-2 gap-4 py-5 h-fit w-full'>
                    <div className='space-y-4 py-4 px-4 flex flex-col justify-center items-center bg-blue-50 rounded-xl'>
                        <p className='text-[60px] '><MdOutlineSecurity /></p>
                        <p className='text-base'>We are offering best security sistem in Bangladesh</p>
                    </div>

                    <div className='space-y-4 py-4 px-4 flex flex-col justify-center items-center bg-rose-50 rounded-xl'>
